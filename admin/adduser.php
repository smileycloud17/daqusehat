...
$tabel = mysqli_query($koneksi,"SELECT * FROM tb_user_admin ORDER BY id DESC");
...
$dataadmin = "SELECT * FROM tb_user_admin ORDER BY id DESC LIMIT $start, $perPage";
$dataadmin_limit = mysqli_query($koneksi, $dataadmin);

$data = mysqli_query($koneksi,"select * from tb_user_admin");
    ...
    <div class="main">
        <div class="topbar">
            <div class="">
                ...
                <span class="title-main">Data Staff User<span>
            </div>
            <!-- Mesin Pencari -->
            <!-- <div class="search">
                <label>
                ...
                <div>
                    ...
                    <div class="search">
                        ...
                        <form action="adduser.php" method="post">
                            <input type="text" placeholder="Search" name="cari" autocomplete="off">
                            <button type="submit" name="search"><i class='fas fa-search'></i></button>
                        </form>
                         </label>
                    </div>
                    <div class="tombol-tambah">
                        <a href="tambahuser"><i class='fas fa-user-plus'></i>Tambah User</a>
                    </div>
                    <form action="" method="post">
                        <table class="content-table">
                            ...
                            <tbody>
                                <?php if(mysqli_num_rows($dataadmin_limit)>0){ ?>
                                <?php
                                    $no = 1;
                                    while($d = mysqli_fetch_array($dataadmin_limit)){
                                ?>
                                <tr>
                                    <td><?php echo $no;?></td>
                                    ...
                                    <td>
                                        <a href="edituser.php?id=<?php echo $d['id'] ?>"><i class='far fa-edit' style="color:#4FBDBA"></i></a>
                                        <a href="" onClick="confirm_modal('proses_hapus_user.php?id=<?php echo $d['id'] ?>')" data-bs-toggle="modal" data-bs-target="#ModalDelete"><i class='fas fa-trash-alt' style="color:red"></i></a>
                                    </td>
                                </tr>
                                <?php $no++; } ?>
                                <?php } ?>
