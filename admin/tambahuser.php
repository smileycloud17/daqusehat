    ...
    <div class="main">
        <div class="topbar">
            <div class="">
                ...
                <span class="title-main">Tambah Data User<span>
            </div>
            <!-- Mesin Pencari -->
            <!-- <div class="search">
                <label>
        ...
        <div class="edit">
            <div class="user-profil">
                ...
                <form action="proses_regis_user.php" method="POST">
                    <div class="inputan-profil">
                        <div class="inputProfil">
                            <span class="detil">No. KTA</span>
                            <input class="forminput" type="text" id="kta" name="kta" required>
                        </div>
                        <div class="inputProfil">
                            <span class="detil">Username</span>
                            <input class="forminput" type="text" id="username" name="username" required>
                        </div>
                        <div class="inputProfil">
                            <span class="detil">Nama User</span>
                            <input class="forminput" type="text" id="nama" name="nama" required>
                        </div>
                        <div class="inputProfil">
                            <span class="detil">E-mail</span>
                            <input class="forminput" type="text" id="email" name="email" required>
                        </div>
                        <div class="inputProfil">
