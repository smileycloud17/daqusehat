    ...
    <div class="main">
        <div class="topbar">
            <div class="">
                ...
                <span class="title-main">Edit Data User<span>
            </div>
            <!-- Mesin Pencari -->
            <!-- <div class="search">
                <label>
        ...
        <div class="edit">
            <div class="user-profil">
                ...
                <?php 
                $data = mysqli_query($koneksi,"select * from tb_user_admin where id='$id'");
                $nomor = 1;
                ...
                <form action="proses_edit_user.php" method="POST">
                    <div class="inputan-profil">
                        <div class="inputProfil">
                            ...
                            <input class="forminput" type="text" id="kta" name="kta" value="<?php echo $d['kta'] ?>" required>
                        </div>
                        <div class="inputProfil">
                            <span class="detil">Username</span>
                            <input class="forminput" type="text" id="username" name="username" value="<?php echo $d['username'] ?>" required>
                        </div>
                        <div class="inputProfil">
                            <span class="detil">Nama User</span>
                            <input class="forminput" type="text" id="nama" name="nama" value="<?php echo $d['nama_pengguna'] ?>" required>
                        </div>
                        <div class="inputProfil">
                            <span class="detil">E-mail</span>
                            <input class="forminput" type="text" id="email" name="email" value="<?php echo $d['email'] ?>" required>
                        </div>
                        <div class="inputProfil">
                            <span class="detil">Unit</span>
                            <select name="keterangan" id="keterangan" >
                                <option value="">--Pilih Unit--</option>
                                <?php
                                $sql_unit=mysqli_query($koneksi,"SELECT * FROM master_unit");
                                while ($data_unit=mysqli_fetch_array($sql_unit)) {
                                    if ($d['keterangan']==$data_unit['unit']) {
                                    $select="selected";
                                    }else{
                                    $select="";
                                    }
                                    echo "<option value=".$data_unit['unit']." $select>".$data_unit['unit']."</option>";
                                }
                                ?>
