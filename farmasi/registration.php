                ...
                <form action="">
                    <div class="input-details">
                        ...
                        <div class="inputbox">
                            ...
                            <input class="forminput" type="text" id="nobpjs" name="" >
                        </div>
                        <div class="inputbox">
                        ...
                        <div class="inputbox">
                            ...
                            <input class="forminput" type="date" id="indate" name="" >
                        </div>
                        <div class="inputbox">
                            <span class="detil">Resep Obat</span>
                            <input class="forminput" type="text" id="rspmed" name="" required>
                        </div>
                        <div class="inputbox">
                            <span class="detil">Keterangan Keluhan</span>
                            <textarea name="" id="ummketkeluh" cols="30" rows="5" required></textarea>
                        </div>
                        <div class="inputbox">
