...
<!-- Loading End -->
    ...
    <div class="main">
        <div class="topbar">
            <div class="">
                ...
                <span class="title-main">Input Data Pasien<span>
            </div>
            <!-- Mesin Pencari -->
            <!-- <div class="search">
                <label>
        ...
        <div class="cardbox4">
            <div class="card-3">
                <center>
                    <h2>Halaman Input Data Pasien</h2><br>
                    ...
                    <a href="addpasien" class="btnrr"><i class="fa fa-plus-square"></i>Tambah Pasien</a>
                </center>
            </div>
        </div>
        <footer>
    ...
    <script>
        ...
        stuckNav = localStorage.getItem("angin");
