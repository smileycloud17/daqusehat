            ...
            function update() {
                $.getJSON("data_riwayat_dashboard.php", function(data) {
                    ...
                    $.each(data.result, function() {
                        ...
                        $("tbody").append("<tr><td>"+(no++)+"</td><td>"+this['no_rm']+"</td><td>"+this['no_bpjs']+"</td><td>"+this['nik']+"</td><td>"+this['nama_pasien']+"</td><td>"+tanggal+"-"+bulan+"-"+tahun+"</td><td>"+this['no_telp']+"</td><td>"+this['alamat']+"</td></tr>");
                    });
                });
            }
        </script>
